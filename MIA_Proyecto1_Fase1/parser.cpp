...
union YYSTYPE
{
#line 31 "Sintactico.y" /* yacc.c:355  */
...
{
       0,   118,   118,   120,   125,   130,   135,   140,   145,   150,
     156,   160,   165,   171,   175,   179,   183,   187,   192,   193,
     194,   196,   202,   209,   213,   218,   224,   228,   232,   236,
     240,   244,   248,   252,   256,   260,   264,   265,   267,   271,
     276,   282,   286,   290,   295,   300,   304,   309,   315,   319,
     323,   327,   332,   338,   345,   349
};
#endif
...
{
  "$end", "error", "$undefined", "tk_Size", "tk_Fit", "tk_Unit",
  "tk_Path", "tk_Type", "tk_Delete", "tk_Name", "tk_Add", "tk_ID",
  "tk_MKd", "tk_RMd", "tk_Fd", "tk_Mount", "tk_UnMount", "tk_Rep",
  "tk_Exec", "tk_Bf", "tk_Ff", "tk_Wf", "tk_Fast", "tk_Full", "numero",
  "decimal", "cadena", "id", "ruta", "mas", "menos", "por", "division",
  "potencia", "igual", "parentA", "parentC", "llaveA", "llaveC", "corcheA",
  "corcheC", "exclama", "puntoComa", "coma", "simple", "UMINUS", "$accept",
  "INICIO", "COMANDOS_T", "MKdisk", "LISTA_MKD", "OPCIONES_MKD",
  "OPCIONES_FIT", "RMdisk", "Fdisk", "LISTA_FD", "OPCIONES_FD",
  "OPCIONES_DELETE", "MOUNT", "LISTA_MOUNT", "OPCIONES_MOUNT", "UNMOUNT",
  "REPORTES", "LISTA_REPORTES", "OPCIONES_REPOTES", "SCRIPT", "VAL_NUM", YY_NULLPTR
};
#endif
...
{
      -4,    20,    28,    -3,    10,     7,    11,    30,    43,   -10,
      15,    17,    18,    19,   -10,    20,   -10,    22,   -10,    24,
      25,    26,    27,    29,    31,    32,    33,   -10,    -3,   -10,
      34,    35,   -10,    10,   -10,    36,   -10,    37,    38,    39,
      11,   -10,   -10,    40,   -10,   -10,    51,     8,    49,     4,
     -10,     5,    53,     8,    52,     9,    54,    23,    21,    -9,
     -10,    12,    55,   -10,    56,    13,    57,    58,   -10,    16,
...
{
       0,     0,     0,     0,     0,     0,     0,     0,     0,     2,
       0,     0,     0,     0,     3,    10,    12,     0,     4,     0,
       0,     0,     0,     0,     0,     0,     0,     5,    23,    25,
       0,     0,     6,    38,    40,     0,     7,     0,     0,     0,
       8,    45,    47,     0,     9,     1,     0,     0,     0,     0,
      11,     0,     0,     0,     0,     0,     0,     0,     0,     0,
      24,     0,     0,    39,     0,     0,     0,     0,    46,     0,
      13,    18,    19,    20,    14,    15,    17,    16,    22,    21,
      26,    31,    27,    29,    28,    30,    36,    37,    32,    33,
      34,    54,     0,    35,    42,    41,    43,    44,    50,    49,
      48,    51,    53,    52,    55
};
...
{
     -10,   -10,   -10,   -10,   -10,    42,     1,   -10,   -10,   -10,
      50,   -10,   -10,   -10,    47,   -10,   -10,   -10,    48,   -10,
     -10
};
...
{
      -1,     8,     9,    14,    15,    16,    74,    18,    27,    28,
      29,    88,    32,    33,    34,    36,    40,    41,    42,    44,
      93
};
...
static const yytype_uint8 yytable[] =
{
      19,    20,    21,    22,    23,    24,    25,    26,     1,     2,
       3,     4,     5,     6,     7,    91,    30,    37,    35,    31,
      38,    92,    39,    10,    11,    12,    13,    71,    72,    73,
      76,    78,    77,    79,    17,    83,    43,    84,    94,    98,
      95,    99,   102,    45,   103,    86,    87,    89,    90,    46,
       0,    47,    48,    49,    81,     0,    51,    50,    52,    53,
      54,    55,     0,    56,     0,    57,    58,    59,    61,    62,
      64,    65,    66,    67,    69,    70,    75,    80,    60,    82,
      63,    85,    96,    97,   100,   101,   104,     0,    68
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     7,     8,     9,    10,    12,    13,
      14,    15,    16,    17,    18,    24,     6,     6,    11,     9,
       9,    30,    11,     3,     4,     5,     6,    19,    20,    21,
      26,    26,    28,    28,     6,    26,     6,    28,    26,    26,
      28,    28,    26,     0,    28,    22,    23,    26,    27,    34,
      -1,    34,    34,    34,    53,    -1,    34,    15,    34,    34,
      34,    34,    -1,    34,    -1,    34,    34,    34,    34,    34,
      34,    34,    34,    34,    34,    24,    27,    24,    28,    27,
      33,    27,    27,    27,    27,    27,    24,    -1,    40
};
...
{
       0,    12,    13,    14,    15,    16,    17,    18,    47,    48,
       3,     4,     5,     6,    49,    50,    51,     6,    53,     3,
       4,     5,     6,     7,     8,     9,    10,    54,    55,    56,
       6,     9,    58,    59,    60,    11,    61,     6,     9,    11,
      62,    63,    64,     6,    65,     0,    34,    34,    34,    34,
      51,    34,    34,    34,    34,    34,    34,    34,    34,    34,
      56,    34,    34,    60,    34,    34,    34,    34,    64,    34,
      24,    19,    20,    21,    52,    27,    26,    28,    26,    28,
      24,    52,    27,    26,    28,    27,    22,    23,    57,    26,
      27,    24,    30,    66,    26,    28,    27,    27,    26,    28,
      27,    27,    26,    28,    24
};
...
#line 120 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, "INICIO");
...
#line 156 "Sintactico.y" /* yacc.c:1646  */
    {(yyval.nodo) = (yyvsp[0].nodo);//new Nodo_AST(@1.first_line, @1.first_column,"MKDISK");
                   //$$->add(*$1);
                  }
...
#line 165 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[0]).first_line,(yylsp[0]).first_column, "MKDISK");
...
#line 171 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "SIZE");
                                     Nodo_AST *nodo = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, (yyvsp[0].TEXT));
                                     (yyval.nodo)->add(*nodo);
                                    }
...
#line 175 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "FIT");
...
#line 179 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "UNIT");
                                 Nodo_AST *nodo = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, (yyvsp[0].TEXT));
                                 (yyval.nodo)->add(*nodo);
                               }
...
#line 183 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "PATH");
                                   Nodo_AST *nodo = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, (yyvsp[0].TEXT));
                                   (yyval.nodo)->add(*nodo);
                                  }
...
#line 192 "Sintactico.y" /* yacc.c:1646  */
    {(yyval.nodo) = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, (yyvsp[0].TEXT));}
...
#line 196 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column,"RMDISK");
                             Nodo_AST *nodo1 = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column,"PATH");
                             Nodo_AST *nodo2 = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column,(yyvsp[0].TEXT));
                             nodo1->add(*nodo2);
                             (yyval.nodo)->add(*nodo1);
                           }
...
#line 209 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = (yyvsp[0].nodo);/*new Nodo_AST(@1.first_line, @1.first_column,"FDISK");
                  $$->add(*$1);*/
                }
...
#line 218 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column,"FDISK"); 
                            //Nodo_AST *nodo = new Nodo_AST(@1.first_line, @1.first_column,"OPCIONES_FD");
                            //nodo->add(*$1);
                            (yyval.nodo)->add(*(yyvsp[0].nodo));
                           }
...
#line 240 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "TYPE");
                                 Nodo_AST *nodo = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, (yyvsp[0].TEXT));
                                 (yyval.nodo)->add(*nodo);
                                }
...
#line 248 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "DELETE");
                                                //Nodo_AST *nodo = new Nodo_AST(@3.first_line, @3.first_column, $3);
                                                (yyval.nodo)->add(*(yyvsp[0].nodo));
                                               }
...
#line 252 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "NAME");
                                     Nodo_AST *nodo = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, (yyvsp[0].TEXT));
                                     (yyval.nodo)->add(*nodo);  
                                    }
...
#line 260 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "ADD");
                                     (yyval.nodo)->add(*(yyvsp[0].nodo));
                                    }
...
#line 267 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = (yyvsp[0].nodo);/*new Nodo_AST(@1.first_line, @1.first_column,"MOUNT");
                     $$->add(*$1);*/
                    }
...
#line 276 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, "MOUNT");
                              //Nodo_AST *nodo = new Nodo_AST(@1.first_line, @1.first_column, "OPCIONES_MOUNT");
                              //nodo->add(*$1);
                              (yyval.nodo)->add(*(yyvsp[0].nodo));
                             }
...
#line 295 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line,(yylsp[-2]).first_column, "UNMOUNT");
                          Nodo_AST *nodo = new Nodo_AST((yylsp[0]).first_line,(yylsp[0]).first_column, (yyvsp[0].TEXT));
                          (yyval.nodo)->add(*nodo);
                         }
...
#line 300 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = (yyvsp[0].nodo);/*new Nodo_AST(@1.first_line,@1.first_column, "REPORTES");
                           $$->add(*$1);*/ 
                          }
...
#line 309 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, "REPORTES");
...
#line 327 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "ID");
                               Nodo_AST *nodo = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, (yyvsp[0].TEXT));
                               (yyval.nodo)->add(*nodo);
                              }
...
#line 332 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "SCRIPT");
                             Nodo_AST *nodo1 = new Nodo_AST((yylsp[-2]).first_line, (yylsp[-2]).first_column, "PATH");
                             Nodo_AST *nodo2 = new Nodo_AST((yylsp[0]).first_line, (yylsp[0]).first_column, (yyvsp[0].TEXT));
                             nodo1->add(*nodo2);
                             (yyval.nodo)->add(*nodo1);
                            }
...
#line 345 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[0]).first_line,(yylsp[0]).first_column,"VAL_NUM");
                  Nodo_AST *nod1 = new Nodo_AST((yylsp[0]).first_line,(yylsp[0]).first_column,(yyvsp[0].TEXT));
                  (yyval.nodo)-> add(*nod1);
                }
...
#line 349 "Sintactico.y" /* yacc.c:1646  */
    { (yyval.nodo) = new Nodo_AST((yylsp[-1]).first_line,(yylsp[-1]).first_column,"VAL_NUM");
                                          //Nodo_AST *nod1 = new Nodo_AST(@1.first_line,@1.first_column,$1);
                                          QString a = (yyvsp[-1].TEXT);
                                          QString b = (yyvsp[0].TEXT);
                                          QString c = a + b;
                                          Nodo_AST *nod2 = new Nodo_AST((yylsp[0]).first_line,(yylsp[0]).first_column,c);
                                          //$$-> add(*nod1);
                                          (yyval.nodo)-> add(*nod2);
                                        }
...
#line 360 "Sintactico.y" /* yacc.c:1906  */
